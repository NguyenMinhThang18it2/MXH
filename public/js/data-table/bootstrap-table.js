...
(function ($) {
    ...
    BootstrapTable.prototype.initToolbar = function () {
        ...
        if (this.options.search) {
            html = [];
            html.push(
                '<button type="button" class="buton-creat-user" data-toggle="modal" data-target="#exampleModal"><i class="fas fa-plus-circle"></i> Creat new</button>',
